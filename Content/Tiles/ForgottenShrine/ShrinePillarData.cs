...
{
    private static readonly Asset<Texture2D> pillarTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/ShrinePillar");

    private static readonly Asset<Texture2D> pillarTopTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/ShrinePillarTop");

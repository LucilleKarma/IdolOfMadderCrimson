...
public class ShimenawaRopeData : WorldOrientedTileObject
{
    ...
    private static readonly Asset<Texture2D> bellTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/Bell");

    private static readonly Asset<Texture2D> ropeTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/Rope");

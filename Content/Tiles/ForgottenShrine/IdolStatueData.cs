...
{
    private static readonly Asset<Texture2D> bowlTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/IdolStatueBowl");

    private static readonly Asset<Texture2D> statueTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/IdolStatue");

    private static readonly Asset<Texture2D> waterTimeMapTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/IdolStatueWaterTimeMap");

    private static readonly Asset<Texture2D> waterGlowTexture = ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/IdolStatueWaterGlow");
    ...
    public override void Render()
    {
        ...
        ManagedShader waterShader = ShaderManager.GetShader("IdolOfMadderCrimson.ShrineBowlWaterShader");
    ...
    {
        ManagedShader lightShader = ShaderManager.GetShader("IdolOfMadderCrimson.LightingShader");

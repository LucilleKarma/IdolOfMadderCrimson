...
public class TEPlacedOfuda : ModTileEntity, IClientSideTileEntityUpdater
{
    ...
    [
        ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/PlacedOfuda1"),
        ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/PlacedOfuda2"),
        ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/PlacedOfuda3"),
    ];

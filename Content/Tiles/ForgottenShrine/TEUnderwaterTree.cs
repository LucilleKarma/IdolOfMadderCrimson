...
public class TEUnderwaterTree : ModTileEntity
{
    ...
    [
        ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/UnderwaterTree1"),
        ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/UnderwaterTree2"),
        ModContent.Request<Texture2D>("IdolOfMadderCrimson/Content/Tiles/ForgottenShrine/UnderwaterTree3")
    ];

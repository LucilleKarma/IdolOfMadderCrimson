...
namespace IdolOfMadderCrimson.Content.Waters;

public class ForgottenShrineWaterflow : ModWaterfallStyle { }

public class ForgottenShrineWater : ModWaterStyle
{
    public override int ChooseWaterfallStyle() => ModContent.Find<ModWaterfallStyle>("IdolOfMadderCrimson/ForgottenShrineWaterflow").Slot;
